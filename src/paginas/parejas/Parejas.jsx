...
function Parejas() {
  ...
  const productosParejas = [
    {
      nombre: "Chaqueta coordinada - Él",
      descripcion:
        "Chaqueta coordinada para él - Diseño moderno y cómodo para salidas y celebraciones.",
      precio: "$189.900",
      precioAntiguo: "$209.900",
      imagen:
        "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&w=400&q=80",
    },
    {
      nombre: "Chaqueta coordinada - Ella",
      descripcion:
        "Chaqueta coordinada para ella - Diseño romántico y ligero para celebraciones en pareja.",
      precio: "$179.900",
      precioAntiguo: "$199.900",
      imagen:
        "https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?auto=format&fit=crop&w=400&q=80",
    },
    {
      nombre: "Set camisetas pareja",
      descripcion:
        "Set de camisetas coordinadas para pareja, diseño casual ideal para el día a día.",
      precio: "$129.900",
      precioAntiguo: "$149.900",
      imagen:
        "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?auto=format&fit=crop&w=400&q=80",
    },
    {
      nombre: "Bufandas coordinadas",
      descripcion:
        "Bufandas coordinadas para pareja, ideales para el frío. Tejido suave y abrigado.",
      precio: "$89.900",
      precioAntiguo: "$109.900",
      imagen:
  ...
  useEffect(() => {
    ...
    const sincronizarFavoritos = () =>
      setFavoritos(window.SenabellaFavoritos.obtenerLista());
  ...
  const esFavorito = (nombre) =>
    favoritos.some(
      (favorito) =>
        favorito.nombre?.trim().toLowerCase() === nombre.trim().toLowerCase(),
    );
      ...
      <section className='parejas-hero'>
        <div className='parejas-hero-contenido'>
          <span className='badge-hero'>
            <i className='fa-solid fa-heart'></i> COLECCIÓN PAREJAS
          </span>
          <h1>
            Ropa elegante para compartir <span>momentos inolvidables</span>
          </h1>
          <p>
            Descubre outfits coordinados, tonos románticos y detalles
            sofisticados pensados para la vida en pareja.
          </p>
          <a
            href='#catalogo-parejas'
      ...
      <div className='parejas-contenedor'>
        ...
        <section className='parejas-info-cards'>
          <div className='info-card' id='info-looks'>
            ...
            <p>
              Conjuntos pensados para combinar con estilo. Colores, texturas y
              cortes que se complementan a la perfección.
            </p>
          </div>
          ...
          <div className='info-card' id='info-ocasiones'>
            ...
            <p>
              Desde cenas románticas hasta celebraciones especiales, tenemos el
              outfit perfecto para cada momento.
            </p>
          </div>
          ...
          <div className='info-card' id='info-entrega'>
            ...
            <p>
              Servicio de empaque especial, asesoría personalizada y entrega
              cuidada para una experiencia memorable.
            </p>
          </div>
        </section>
          ...
          <div className='galeria-grid'>
            ...
            <article
              ...
              onClick={() =>
                verProductoParejas(
                  "Look de pareja",
                  "SENABELLA MODA",
                  "Propuesta elegante y romántica para celebraciones con estilo y coordinación.",
                  "$ 359.900",
                  "$ 399.900",
                  imgPareja,
                )
            ...
            >
              ...
              <div className='galeria-card-info'>
                ...
                <p>
                  Propuesta elegante y romántica pensada para celebraciones con
            ...
            <article
              ...
              onClick={() =>
                verProductoParejas(
                  "Conjunto coordinado",
                  "SENABELLA MODA",
                  "Propuesta moderna con tonos neutros y detalles sofisticados para coordinar el estilo.",
                  "$ 289.900",
                  "$ 329.900",
                  imgImages,
                )
            ...
            >
              ...
              <div className='galeria-card-info'>
                ...
                <p>
                  Propuesta moderna con tonos neutros y detalles sofisticados
                  para coordinar el estilo.
                </p>
              </div>
            </article>
            ...
            <article
              ...
              onClick={() =>
                verProductoParejas(
                  "Detalle romántico",
                  "SENABELLA BOUTIQUE",
                  "Texturas suaves, cortes delicados y acabados inspirados en una boutique elegante para novios.",
                  "$ 199.900",
                  "$ 239.900",
            ...
            >
              <div className='galeria-card-imagen'>
                <img
                  ...
                  alt='Detalle romántico de ropa elegante'
                  loading='lazy'
                />
              ...
              <div className='galeria-card-info'>
                ...
                <p>
                  Texturas suaves, cortes delicados y acabados inspirados en una
                  boutique elegante para novios.
                </p>
              </div>
            </article>
          </div>
          ...
          <div className='row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4 productos-parejas-grid'>
            <div className='col'>
              <div
                ...
                onClick={() =>
                  verProductoParejas(
                    productosParejas[0].nombre,
                    "SENABELLA MODA",
                    productosParejas[0].descripcion,
                    productosParejas[0].precio,
                    productosParejas[0].precioAntiguo,
                    productosParejas[0].imagen,
                  )
                }
              >
                ...
                <button
                  type='button'
                  className={`btn-favorito ${esFavorito(productosParejas[0].nombre) ? "favorito-activo" : ""}`}
                  aria-label='Agregar a favoritos'
                  onClick={(e) => handleFavorito(e, productosParejas[0])}
                >
                  <i
                    className={`${esFavorito(productosParejas[0].nombre) ? "fa-solid" : "fa-regular"} fa-heart`}
                  ></i>
                </button>
                <img
                  ...
                  height='200'
                  alt='Chaqueta coordinada para él'
                  loading='lazy'
                />
                <div className='card-body d-flex flex-column justify-content-between'>
                  <h3 className='card-title h6 text-truncate'>
                    Chaqueta coordinada - Él
                  </h3>
            ...
            <div className='col'>
              <div
                ...
                onClick={() =>
                  verProductoParejas(
                    productosParejas[1].nombre,
                    "SENABELLA MODA",
                    productosParejas[1].descripcion,
                    productosParejas[1].precio,
                    productosParejas[1].precioAntiguo,
                    productosParejas[1].imagen,
                  )
                }
              >
                <div className='card-badge badge-nuevo'>Nuevo</div>
                <button
                  type='button'
                  className={`btn-favorito ${esFavorito(productosParejas[1].nombre) ? "favorito-activo" : ""}`}
                  aria-label='Agregar a favoritos'
                  onClick={(e) => handleFavorito(e, productosParejas[1])}
                >
                  <i
                    className={`${esFavorito(productosParejas[1].nombre) ? "fa-solid" : "fa-regular"} fa-heart`}
                  ></i>
                </button>
                <img
                  ...
                  className='card-img-top p-3 object-fit-contain'
                  height='200'
                  alt='Chaqueta coordinada para ella'
                  loading='lazy'
                />
                <div className='card-body d-flex flex-column justify-content-between'>
                  <h3 className='card-title h6 text-truncate'>
                    Chaqueta coordinada - Ella
                  </h3>
                  ...
                  <button
                    ...
                    onClick={(e) =>
                      handleAgregarCarrito(e, {
                        nombre: "Chaqueta coordinada - Ella",
                        precio: "$179.900",
                        img: "https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?auto=format&fit=crop&w=400&q=80",
                      })
                    }
                  >
                    <i className='fa-solid fa-cart-plus'></i> Agregar
            ...
            <div className='col'>
              <div
                ...
                onClick={() =>
                  verProductoParejas(
                    productosParejas[2].nombre,
                    "SENABELLA MODA",
                    productosParejas[2].descripcion,
                    productosParejas[2].precio,
                    productosParejas[2].precioAntiguo,
                    productosParejas[2].imagen,
                  )
                }
              >
                ...
                <button
                  type='button'
                  className={`btn-favorito ${esFavorito(productosParejas[2].nombre) ? "favorito-activo" : ""}`}
                  aria-label='Agregar a favoritos'
                  onClick={(e) => handleFavorito(e, productosParejas[2])}
                >
                  <i
                    className={`${esFavorito(productosParejas[2].nombre) ? "fa-solid" : "fa-regular"} fa-heart`}
                  ></i>
                </button>
                <img
                  ...
                  className='card-img-top p-3 object-fit-contain'
                  height='200'
                  alt='Set de camisetas para pareja'
                  loading='lazy'
                />
                <div className='card-body d-flex flex-column justify-content-between'>
                  <h3 className='card-title h6 text-truncate'>
                    Set camisetas pareja
                  </h3>
            ...
            <div className='col'>
              <div
                ...
                onClick={() =>
                  verProductoParejas(
                    productosParejas[3].nombre,
                    "SENABELLA MODA",
                    productosParejas[3].descripcion,
                    productosParejas[3].precio,
                    productosParejas[3].precioAntiguo,
                    productosParejas[3].imagen,
                  )
                }
              >
                ...
                <button
                  type='button'
                  className={`btn-favorito ${esFavorito(productosParejas[3].nombre) ? "favorito-activo" : ""}`}
                  aria-label='Agregar a favoritos'
                  onClick={(e) => handleFavorito(e, productosParejas[3])}
                >
                  <i
                    className={`${esFavorito(productosParejas[3].nombre) ? "fa-solid" : "fa-regular"} fa-heart`}
                  ></i>
                </button>
                <img
                  ...
                  className='card-img-top p-3 object-fit-contain'
                  height='200'
                  alt='Bufandas coordinadas pareja'
                  loading='lazy'
                />
                <div className='card-body d-flex flex-column justify-content-between'>
                  <h3 className='card-title h6 text-truncate'>
                    Bufandas coordinadas
                  </h3>
                  ...
                  <button
                    ...
                    onClick={(e) =>
                      handleAgregarCarrito(e, {
                        nombre: "Bufandas coordinadas",
                        precio: "$89.900",
                        img: "https://images.unsplash.com/photo-1611312449408-fcece27cdbb7?auto=format&fit=crop&w=400&q=80",
                      })
                    }
                  >
                    <i className='fa-solid fa-cart-plus'></i> Agregar
        ...
        <section className='parejas-cta'>
          <div className='parejas-cta-contenido'>
            ...
            <p>
              Consulta con nuestros asesores de estilo y recibe recomendaciones
              personalizadas.
            </p>
