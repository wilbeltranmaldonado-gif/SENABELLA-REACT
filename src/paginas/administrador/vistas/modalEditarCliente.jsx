...
function ModalEditarCliente({ cliente, alCerrar, alGuardar }) {
  ...
  const inicial = String(formData.nombre || "C")
    .charAt(0)
    .toUpperCase();
  ...
  return (
    ...
    >
      ...
      >
        {/* CABECERA ESTÉTICA */}
        <div
          className='admin-modal-cabecera'
          style={{
            background: "#f8fafc",
            padding: "18px 24px",
            display: "flex",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
            <div
              style={{
                ...
                height: "42px",
                borderRadius: "50%",
                background: "linear-gradient(135deg, #84b814 0%, #65900c 100%)",
                color: "#ffffff",
                display: "flex",
                alignItems: "center",
                ...
                fontSize: "18px",
                fontWeight: 700,
                boxShadow: "0 2px 8px rgba(132, 184, 20, 0.3)",
              }}
            >
              {inicial}
            </div>
        ...
        >
          ...
          >
            ...
            >
              <i className='fa-solid fa-user' style={{ color: "#84b814" }}></i>{" "}
