...
const categorias = [
  {
    ...
    titulo: "Mis Pedidos",
    desc: "Rastreo, modificaciones y estado de compras",
  },
  {
    icono: "fa-solid fa-truck-fast",
    titulo: "Envíos y Entregas",
    desc: "Tiempos, fletes express y cobertura nacional",
  },
  {
    icono: "fa-solid fa-rotate-left",
    titulo: "Cambios y Devoluciones",
    desc: "Políticas de retracto, tallas y devoluciones",
  },
  {
    icono: "fa-solid fa-credit-card",
    titulo: "Pagos y Facturación",
    desc: "PSE, tarjetas, Addi, Efecty y facturación",
  },
  {
    icono: "fa-solid fa-user",
    titulo: "Mi Cuenta",
    desc: "Guía de tallas, contraseñas y datos personales",
  },
  {
    icono: "fa-solid fa-tags",
    titulo: "Promociones y Cupones",
    desc: "Redención de códigos, ofertas y gift cards",
  },
  {
    icono: "fa-solid fa-shield-halved",
    titulo: "Garantías y Calidad",
    desc: "Defectos de fábrica y cuidado de prendas",
  },
  {
    icono: "fa-solid fa-store",
    titulo: "Tiendas Físicas",
    desc: "Ubicaciones, horarios y compras en boutique",
  },
];
...
const preguntasFAQ = [
  {
    texto: "¿Dónde encuentro mi número de guía?",
    respuesta:
      'Tu número de guía se enviará automáticamente a tu correo electrónico una vez el pedido haya sido despachado. También puedes encontrarlo en "Mi Cuenta" > "Mis Pedidos".',
  },
  {
    texto: "¿Puedo cancelar o editar un pedido?",
    respuesta:
      "Sí, puedes solicitar cambios o cancelar tu pedido dentro de los primeros 30 minutos de haber realizado la compra antes de que entre a preparación.",
  },
  {
    texto: "¿Los productos tienen garantía?",
    respuesta:
      "Todos nuestros productos cuentan con garantía de 30 días calendario por defectos de fábrica. Conserva tu factura para hacerla efectiva.",
  },
  {
    texto: "¿Qué medios de pago puedo utilizar?",
    respuesta:
      "Aceptamos tarjetas de crédito/débito, PSE (Nequi/Daviplata), Addi (cuotas sin tarjeta) y pago en efectivo en puntos Efecty.",
  },
  {
    texto: "¿Cuánto demora un envío nacional?",
    respuesta:
      "En ciudades principales como Bogotá, Medellín y Cali el tiempo es de 1 a 3 días hábiles. En el resto del país de 3 a 5 días hábiles.",
  },
  {
    texto: "¿Cómo solicito un cambio de talla?",
    respuesta:
      "Tienes hasta 30 días calendario tras recibir tu pedido. Ingresa a la sección de soporte o contáctanos para generar tu autorización de cambio.",
  },
  {
    texto: "¿Dónde están ubicadas las tiendas físicas?",
    respuesta:
      "Contamos con boutiques físicas en Bogotá (C.C. Unicentro), Medellín (C.C. El Tesoro) y Cali (C.C. Chipichape).",
  },
  {
    texto: "¿Cómo aplico un cupón de descuento?",
    respuesta:
      'En la pantalla de pago (Checkout), introduce tu código en la casilla "¿Tienes un cupón?" y presiona "Aplicar".',
  },
];
...
function Soporte() {
  ...
  const [resultadoArticulos, setResultadoArticulos] = useState(
    articulosDatos.slice(0, 6),
  );
  ...
  const realizarBusqueda = (queryForzada) => {
    ...
    if (query.length > 0) {
      ...
      setTimeout(() => {
        ...
        setTituloSeccion(
          `Resultados para "${rawQuery.trim()}" (${resultados.length})`,
        );
      ...
      <div className='soporte-contenedor'>
        ...
        <section className='faq-soporte'>
          ...
          <div className='faq-grid'>
            <FaqSoporte preguntas={preguntasFAQ} />
          </div>
        </section>
          ...
          <div className='modal-contenido' onClick={(e) => e.stopPropagation()}>
            ...
            <div className='modal-footer'>
              ...
              <div className='votos-utilidad'>
                <button
                  className='btn-util'
                  onClick={() => alert("¡Gracias por tu retroalimentación!")}
                >
                  <i className='fa-regular fa-thumbs-up'></i> Sí
                </button>
                <button
                  className='btn-util'
                  onClick={() => alert("Gracias. Trabajaremos para mejorarlo.")}
                >
