...
export const pedidosDemo = [
  ...
  },
  {
    ...
    productos: [
      ...
      {
        nombre:
          'Mochila Antirrobo USB Impermeable Laptop 15.6" Viaje Urbano Negra',
        cantidad: 1,
        precioText: "$ 119.900",
  ...
  },
  {
    ...
    productos: [
      {
        nombre:
          "Look de pareja: Propuesta elegante y romántica para celebraciones",
        cantidad: 1,
        precioText: "$ 359.900",
        img: imgPareja,
        categoria: "Parejas",
      ...
      {
        nombre:
          "Reloj Mujer Michael Kors MK5774 Dorado Acero Inoxidable Elegante",
        cantidad: 1,
        precioText: "$ 599.900",
  ...
  },
  {
    ...
    productos: [
      ...
      {
        nombre:
          "Falda Plisada Midi Mujer Elegante Cintura Alta Color Rosa Blush",
        cantidad: 1,
        precioText: "$ 99.900",
