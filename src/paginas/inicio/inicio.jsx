    ...
    localStorage.setItem(
      ...
      JSON.stringify({
        ...
        descripcion:
          ...
          `${producto.nombre}. Producto seleccionado de Senabella con compra segura y soporte especializado.`,
        origen: "/",
      }),
    );
  ...
  return (
    <>
        ...
        */}
        ...
        <section className='row row-cols-2 row-cols-sm-3 row-cols-md-5 g-3 text-center mb-4 categorias-inicio seccion-animada'>
          {categorias.map((categoria) => (
            <div className='col' key={categoria.categoria}>
              <Link to={categoria.ruta} className='categoria-link'>
        ...
        >
          ...
          <button
            ...
            type='button'
            onClick={() => setSlideActual((slideActual + 1) % banners.length)}
          >
          ...
          {/* Barra de progreso */}
          <div className='barra-progreso-carrusel' key={slideActual}></div>
        </section>
          ...
          <div className='row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4 productos-grid'>
            {productos.map((producto, index) => (
              ...
              >
                ...
                >
                  {producto.descuento && (
                    <div className='card-badge'>{producto.descuento}</div>
                  )}
                    ...
                    <i
                      ...
                      onClick={(e) => {
                        ...
                        if (!window.SenabellaFavoritos) {
                          import("../favoritos/favoritos").then((m) =>
                            m.iniciarFavoritosGlobal(),
                          );
                        }
                        ...
                        e.currentTarget.style.color =
                          e.currentTarget.classList.contains("fa-solid")
                            ? "#e63946"
                            : "";
                      }}
        ...
        <section className='containersg mb-5 seccion-animada'>
          <h2 className='h4 mb-3 text-capitalize'>Lo mejor en promociones</h2>
          ...
          <div className='modal-contenido'>
            ...
            <div className='modal-cuerpo'>
              ...
              <div className='modal-info'>
                <h2 className='modal-nombre'>{productoModal.nombre}</h2>

                <p className='modal-precio'>{productoModal.precio}</p>
                ...
                <div className='modal-rating'>
                  ...
                  <span className='modal-rating-text'>4.5 (128 reseñas)</span>
                </div>

                <p className='modal-descripcion'>
                  Producto de alta calidad disponible en Senabella. Envío gratis
                  a todo Colombia.
                </p>
                ...
                <div className='modal-cantidad'>
                  ...
                  <div className='modal-selector-cantidad'>
                    ...
                    <span className='modal-num-cantidad'>{cantidad}</span>

                    <button
                      onClick={() => {
                        const stock = obtenerStockDeProducto(
      ...
      <button
        ...
        className={mostrarArriba ? "btn-arriba-visible" : ""}
        onClick={() =>
          window.scrollTo({
            top: 0,
            behavior: "smooth",
